 ...
 * support com.msr.better performance when accessed concurrently. This implementation follows the
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
	...
	/**
	 * A single segment used to divide the map to allow com.msr.better concurrent performance.
	 */
