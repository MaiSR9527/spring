...
needs com.msr.better than some of the other alternatives described below. Consult the javadocs for
...
To com.msr.better understand, let's explore an example.
