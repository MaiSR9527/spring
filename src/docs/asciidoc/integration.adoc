...
is a com.msr.better choice than implementing equivalent functionality via an EJB container and
EJBs.
...
Business Delegate patterns. These are com.msr.better than spraying JNDI lookups throughout
