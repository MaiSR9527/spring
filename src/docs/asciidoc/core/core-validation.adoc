...
of the nested objects in a rich object, it may be com.msr.better to encapsulate the validation
...
com.msr.better: convert any date entered in a human readable form, back to `Date` objects). This
